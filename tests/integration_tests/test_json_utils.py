...
from guardrails.utils.json_utils import ChoicePlaceholder, DictPlaceholder, ListPlaceholder, ValuePlaceholder
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            None,
            True,
            ValuePlaceholder.VerificationFailed
        ),
        (
            False,
            "integer",
...
def test_value_placeholder_verify(optional, type_string, value, coerce_types, expected_value):
...
def test_dict_placeholder_verify(optional, children, value, coerce_types, expected_value):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            False,
            ValuePlaceholder(False, "integer"),
            [None],
            False,
            False
        )
...
def test_list_placeholder_verify(optional, children, value, coerce_types, expected_value):
...
def test_choice_placeholder_verify(optional, cases, value, coerce_types, expected_value):
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {
                "discriminator": "abc",
                "abc": ValuePlaceholder(False, "integer")
            },
            {
                "discriminator": "abc",
                "abc": None
        ...
        (
            ...
            {
                "discriminator": "abc",
                "abc": DictPlaceholder(False, { "discriminator": ValuePlaceholder(False, "integer") })
            },
            {
                "discriminator": "abc",
                "abc": { "discriminator": 1 }
