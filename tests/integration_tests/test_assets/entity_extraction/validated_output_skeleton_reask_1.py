...
VALIDATED_OUTPUT_SKELETON_REASK_1 = SkeletonReAsk(incorrect_value={
    'fees': [{'name': 'annual membership fee', 'value': 0.0}, {'name': 'my chase plan fee', 'value': 1.72},
             {'name': 'balance transfers', 'value': 5.0}, {'name': 'cash advances', 'value': 5.0},
             {'name': 'foreign transactions', 'value': 3.0}, {'name': 'late payment', 'value': 0.0},
             {'name': 'over-the-credit-limit', 'value': 0.0}, {'name': 'return payment', 'value': 0.0},
             {'name': 'return check', 'value': 0.0}], 'interest_rates': {'purchase': {'annual_percentage_rate': 0.0,
                                                                         ...
                                                                         'cash_advance': {
                                                                             ...
                                                                             'variation_explanation': 'This APR will vary with the market based on the Prime Rate.'},
                                                                         'penalty': {'annual_percentage_rate': 0.0,
