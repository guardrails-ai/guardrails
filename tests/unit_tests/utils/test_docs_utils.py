...
from guardrails.utils.docs_utils import TextSplitter, get_chunks_from_text, sentence_split
...
def test_get_chunks_from_text_invalid_strategy():
    with pytest.raises(ValueError):
        get_chunks_from_text("Invalid strategy.", chunk_strategy="invalid_strategy", chunk_size=1, chunk_overlap=0)
