...
<Tabs>
<TabItem value="JSONRAILSpec" label="JSON RAIL Spec">
...
<TabItem value="OutputJSON" label="Output JSON">
...
<TabItem value="StringRAILSpec" label="String RAIL Spec">
...
<TabItem value="OutputString" label="Output String">
...
<Tabs>
<TabItem value="RAILSpec" label="RAIL Spec">
...
<TabItem value="CompiledXMLaddedtoprompt" label="Compiled XML added to prompt">
