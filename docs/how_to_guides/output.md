...
Check out the [RAIL Data Types](/docs/api_reference/types#railtypes) page for a list of supported data types.
...
- To see the full list of supported quality criteria, check out the [Validation](/docs/api_reference/validator) page.
