...
<div align="center">
<img src="{require('/img/with_and_without_guardrails.svg')}" alt="Guardrails in your application" width="1500px" />
</div>
...
<div align="center">
<img src="{require('/img/guardrails_hub.gif')}" alt="Guardrails Hub gif" width="600px" />
</div>