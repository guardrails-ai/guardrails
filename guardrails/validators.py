...
@register_validator(name="quality_summary", data_type="string")
class QualitySummary(Validator):
    def __init__(self,
                 input_doc: str,
        ...
        super().__init__(input_doc=input_doc, rating_schema=rating_schema, rating_prompt_tmplt=rating_prompt_tmplt, on_fail=on_fail, rating_model=rating_model, thresh=thresh, rating_guard_kwargs=rating_guard_kwargs)
    ...
    def validate(self, value: Any, metadata: Dict) -> ValidationResult:
        ...
        raw_llm_response, ratings = guard(
            self._llm_api,
            #TODO: Implement Azure logic here
