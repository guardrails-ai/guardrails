...
class Inputs(ArbitraryModel):
    llm_api: Optional[PromptCallableBase] = Field(
        description="The constructed class for calling the LLM.",
        default=None
    )
    ...
    prompt: Optional[Prompt] = Field(
        description="The constructed Prompt class.",
        default=None
    )
    ...
    prompt_params: Optional[Dict] = Field(
        description="The parameters provided by the user that will be formatted into the final LLM prompt.",
        default=None
    )
    ...
    full_schema_reask: bool = Field(
        description="Whether to perform reasks across the entire schema or at the field level.",
        default=None
    )