...
class Instructions(BasePrompt):
    ...
    def format(self, **kwargs):
        ...
        if(len(filtered_kwargs) == 0): 
            warnings.warn('Instructions do not have any variables, if you are migrating follow the new variable convention documented here: https://docs.getguardrails.ai/0-2-migration/')
